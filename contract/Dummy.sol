...
contract EgyptSlotMachine is
    ...
    ERC2981
{
    using ECDSA for bytes32;  //this has to catchup at the end
    ...
    //     0x9c51F42b00f2473135d861768727547a6f2eB140;
    // Address where HeyMint fees are sent
    // address public heymintPayoutAddress =
    //     0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851; // This is the address for the one who using heymint
    address public royaltyAddress = 0x61Aca000835cb2cBD9362666fd07f522e44687e4;  //This is the address of the owner
    address[] public payoutAddresses = [
        0x61Aca000835cb2cBD9362666fd07f522e44687e4
    ];
    ...
    string public name = "Egypt Slot Machine";
    string public symbol = "S3SH";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeie6ngg2j7ck4vfrf5k2as3kjoh2drd3vmpnx7rpuguzegicrfj23i/{id}"
        )
